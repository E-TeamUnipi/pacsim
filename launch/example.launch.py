...
def generate_launch_description():
  ...
  nodePacsim = Node(
          ...
          parameters = [{'use_sim_time':True}, {"track_name" : getFullFilePath(track_name, "tracks")}, {"grip_map_path" : getFullFilePath("gripMap.yaml", "tracks")}, {"track_frame" : track_frame}, {"realtime_ratio" : realtime_ratio}, 
                        ...
                        {"sensors_config_path" : getFullFilePath("sensors.yaml", dir="config")}, {"vehicle_model_config_path" : getFullFilePath("vehicleModel.yaml", dir="config")}, {"lidar_config_path" : getFullFilePath("lidar.yaml", dir="config")}, {"discipline" : discipline}],
          output="screen",
          emulate_tty=True)
